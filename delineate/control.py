...
def get_controller(tree_file, constraints_file, output_prefix, logger=None,
logger_kwargs=None, extra_info_field_value=None,figtree_display_label='species-lineage',
no_primary_tree_file=False,no_translate_tree_tokens=False,
preserve_underscores=True,report_constrained_cumulative_probability_threshold=0.95,
report_constrained_probability_threshold=None,report_mle_only=False,
speciation_completion_rate=None,speciation_completion_rate_estimation_initial=None,
speciation_completion_rate_estimation_max=None,speciation_completion_rate_estimation_min=1e-08,
store_relabeled_trees=None,tree_format='nexus',tree_info=False,truncated_tree_file_size=10,underflow_protection=False,version=False):
...
class Controller(object):
    ...
    def read_tree(self,
        ...
        self.tree = model.LineageTree.get(
                path= tree_file,
                schema= schema, preserve_underscores=preserve_underscores,)
    ...
    def parse_configuration_file(self,
        ...
        print(constraints_file)
        if constraints_file:
            with open(constraints_file) as src:
